...
from app.experience.services.experience_field_service import ExperienceFieldService, FieldRevisionConflictError
...
class ExperienceGlobalSaveService:
    ...
    async def save(
        ...
        try:
            ...
            if request.new_evidence is None:
            ...
            for evidence, changed in evidence_changes:
                ...
                await self._fields.claim_unit(
                    ...
                    next(
                        ...
                        for value in request.evidence_items
                        if value.evidence_id == evidence.id
                    ),
                    ref_id=evidence.id,
                )
