...
from app.workflow_runtime.errors import ToolCallNotFoundError
from app.workflow_runtime.tools.approval import ToolApprovalPolicy
from app.workflow_runtime.tools.approval_service import ToolApprovalService
from app.workflow_runtime.tools.delivery_service import ToolResultDeliveryService
from app.workflow_runtime.tools.execution_service import ToolExecutionService
from app.workflow_runtime.tools.input_service import ToolInputService
from app.workflow_runtime.tools.operation import RegisteredTool
from app.workflow_runtime.tools.persistence import ToolCallStore
from app.workflow_runtime.tools.preparation import ToolCallPreparationService
from app.workflow_runtime.tools.query_service import ToolCallQueryService
...
class ToolLifecycleService:
    """实现可绑定、可持久化且可恢复的完整 ToolLifecycle。"""
    ...
    async def consume_results(
        ...
        *,
        ...
        """批量标记结果已投递，并可加入调用方事务。"""
        await self.store.consume_results(tool_call_ids, resources=resources)
